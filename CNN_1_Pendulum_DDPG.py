...
first_fc_actor = [11 * 11 * 32, 256]
second_fc_actor = [256, 128]
third_fc_actor = [128, Num_action]

first_conv_critic = [8, 8, Num_colorChannel, 16]
second_conv_critic = [4, 4, 16, 32]
first_fc_critic = [11 * 11 * 32 + Num_action, 256]
second_fc_critic = [256, 128]
...
def Critic(x, policy, network_name):
    ...
    h_pool3 = tf.reshape(h_conv2_critic, [-1, first_fc_critic[0] - 1])
